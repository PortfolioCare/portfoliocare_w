...
<template>
  <DropdownMenu>
    ...
    <DropdownMenuContent align="end">
      <DropdownMenuItem @select="open = true"> Content filter preferences </DropdownMenuItem>
      <DropdownMenuSeparator />
  ...
  <Dialog v-model:open="open">
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          The content filter flags text that may violate our content policy. It&apos;s powered by
          our moderation endpoint which is free to use to moderate your OpenAI API traffic. Learn
          more.
        </DialogDescription>
      </DialogHeader>
      <div class="py-6">
  ...
  <AlertDialog v-model:open="showDeleteDialog">
    <AlertDialogContent>
      ...
      <AlertDialogFooter>
        ...
        <Button variant="destructive" @click="showDeleteDialog = false"> Delete </Button>
      </AlertDialogFooter>
    </AlertDialogContent>
  </AlertDialog>
</template>
